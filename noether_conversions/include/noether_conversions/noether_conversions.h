...
#include "noether_msgs/msg/tool_paths.hpp"
...
visualization_msgs::msg::MarkerArray convertToAxisMarkers(
    const noether_msgs::msg::ToolPaths& toolpaths,
    const std::string& frame_id,
    const std::string& ns,
...
visualization_msgs::msg::MarkerArray convertToArrowMarkers(
    const noether_msgs::msg::ToolPaths& toolpaths,
    const std::string& frame_id,
    const std::string& ns,
    const std::size_t start_id = 1,
