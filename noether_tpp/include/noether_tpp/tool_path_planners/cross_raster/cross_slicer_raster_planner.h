...
namespace
{
struct CrossRasterConstructData
{
...
public:
  ...
  void setCrossDimensions(const double width, const double height);
  void setCrossSpacing(const double spacing);
...
protected:
  ...
  CrossRasterConstructData processRasterSlice(vtkSmartPointer<vtkPolyData> raster_lines,
  ...
  std::vector<CrossRasterConstructData> processDiagonalsAtPoint(
