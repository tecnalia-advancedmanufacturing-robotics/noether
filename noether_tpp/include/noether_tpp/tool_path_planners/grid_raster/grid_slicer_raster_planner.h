...
namespace
{
struct GridRasterConstructData
{
...
public:
  ...
  void setIntersectionAngle(const double intersection_angle);
...
protected:
  ...
  GridRasterConstructData processRasterSlice(vtkSmartPointer<vtkPolyData> raster_lines,
